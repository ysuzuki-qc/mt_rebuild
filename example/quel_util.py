...
def example2():
    ...
    freq_Q = [3.87, 4.40, 4.46, 3.68, 3.89, 4.47, 4.50, 3.83, 3.82, 4.37, 4.24, 3.76, 3.88, 4.54, 4.80, 4.01]
    freq_R = [6.16, 6.43, 6.32, 6.03, 6.22, 6.49, 6.36, 6.08, 6.15, 6.43, 6.30, 6.03, 6.20, 6.48, 6.36, 6.09]
    ...
    result = get_multiplex_config(
        channel_to_frequency, channel_to_device, channel_to_port_index, CONST_QuEL1SE_LOW_FREQ
    )
