...
def test_convert_U2():
    ...
    qc = QuantumCircuit(1)
    qc.add_gate(name="u2", targets=[0,], matrix=u)
    u0 = qc.to_matrix()
...
def test_convert_random():
    ...
    qc.add_gate(name="u2", targets=[0,], matrix=unitary_group.rvs(2))
    qc.add_gate(name="u2", targets=[1,], matrix=unitary_group.rvs(2))
    qc.add_gate(name="u2", targets=[2,], matrix=unitary_group.rvs(2))
